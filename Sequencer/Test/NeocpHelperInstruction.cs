...
namespace NINA.RBarbera.Plugin.NeocpHelper.NeocpHelperTestCategory {
    ...
    public class NeocpHelperInstruction : SequenceItem {
        /// <summary>
        ...
        public NeocpHelperInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public NeocpHelperInstruction(NeocpHelperInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new NeocpHelperInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(NeocpHelperInstruction)}, Text: {Text}";
        }
    }
}