...
namespace NINA.RBarbera.Plugin.NeocpHelper.NeocpHelperTestCategory {
    ...
    public class NeocpHelperTrigger : SequenceTrigger {
        /// <summary>
        ...
        public NeocpHelperTrigger() {
        }

        public override object Clone() {
            return new NeocpHelperTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(NeocpHelperTrigger)}";
        }
    }
}