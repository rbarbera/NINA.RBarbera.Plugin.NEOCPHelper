...
namespace NINA.RBarbera.Plugin.NeocpHelper {
    ...
    public class NeocpHelper : PluginBase, INotifyPropertyChanged {
        ...
        private readonly ImagePattern exampleImagePattern = new ImagePattern("$$EXAMPLEPATTERN$$", "An example of an image pattern implementation", "NEOCP Helper");

        [ImportingConstructor]
        public NeocpHelper(IProfileService profileService, IOptionsVM options, IImageSaveMediator imageSaveMediator) {
